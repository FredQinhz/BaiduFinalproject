...
class TextDemo1(val text1:String, val text2:String, val text3:String, val text4: String, val text5: String)
class TextImageDemo1(val text1:String, val text2:String, val text3:String, val text4: String, val text5: String,val imageId: Int)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        with(cursor) {
            while (moveToNext()) {
                ...
                textDemo1List.add(TextDemo1(title,type,author,getString(getColumnIndexOrThrow("abstract")),getString(getColumnIndexOrThrow("article"))))
                i++
            }
        }
        cursor.close()
        ...
        repeat(2) {
            ...
            with(cursor2) {
                while (moveToNext()) {
                    ...
                    textImageDemo1List.add(TextImageDemo1(title, type, author, getString(getColumnIndexOrThrow("abstract")),getString(getColumnIndexOrThrow("article")),image))
                    k++
                }
            }
            cursor2.close()
